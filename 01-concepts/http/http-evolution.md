...
| :--- | :--- | :--- | :--- | :--- |
| [[HTTP 1.0]] | TCP | Text | 1 Connection per Request | Severe |
| [[HTTP 1.1]] | TCP | Text | Persistent (Sequential) | Application-Layer HOLB |
| [[HTTP 2.0]] | TCP | Binary | Multiplexed (Single Connection) | Transport-Layer HOLB |
| [[HTTP 3.0]] | QUIC (over UDP) | Binary | Multiplexed (Independent Streams) | **Completely Eliminated** |
